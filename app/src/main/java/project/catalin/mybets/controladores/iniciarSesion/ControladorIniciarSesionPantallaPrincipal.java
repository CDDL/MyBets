 ...
 */
public class ControladorIniciarSesionPantallaPrincipal implements INotificable, ControllerDestructible {
    ...
    public ControladorIniciarSesionPantallaPrincipal(ViewLoginBase viewLoginBase) {
