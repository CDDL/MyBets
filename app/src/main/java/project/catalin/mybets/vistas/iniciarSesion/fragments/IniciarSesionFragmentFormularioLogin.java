package project.catalin.mybets.vistas.iniciarSesion.fragments;
...
import project.catalin.mybets.controladores.iniciarSesion.fragments.ControladorIniciarSesionFormLogin;
...
public class IniciarSesionFragmentFormularioLogin extends Fragment implements ViewLoginForm {
    private ControllerLoginForm mControllerLoginForm;
    ...
    public IniciarSesionFragmentFormularioLogin() {
        mControllerLoginForm = new ControladorIniciarSesionFormLogin(this);
    }
