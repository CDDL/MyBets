...
public class PantallaPopulares extends AppCompatActivity implements ViewPantallaPartidasPopulares {
    ...
    private ControllerPartidasPopulares mControladorPopulares;
    ...
    private void inicializarControlador() {
        mControladorPopulares = new ControladorPartidasPopulares(this);
        mControladorPopulares.inicializarVista();
    }
    ...
    private void inicializarToolbar() {
        ...
        getSupportActionBar().setTitle(R.string.pantalla_categoria_populares_titulo);
    ...
    public class AdapterPartidas extends AdapterRecargable<Partida> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            PartidaView partidaView = convertView == null? (PartidaView) LayoutInflater.from(PantallaPopulares.this).inflate(R.layout.item_partida, parent, false): (PartidaView) convertView;
