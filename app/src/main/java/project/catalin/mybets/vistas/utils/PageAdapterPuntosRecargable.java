 ...
 */
public abstract class PageAdapterPuntosRecargable<Tipo> extends PagerAdapter implements IconPagerAdapter, ViewPager.OnPageChangeListener {
    List<Tipo> mListElementos;

    public PageAdapterPuntosRecargable() {
