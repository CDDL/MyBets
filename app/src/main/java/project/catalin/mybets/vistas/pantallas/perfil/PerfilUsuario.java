...
public class PerfilUsuario extends AppCompatActivity implements ViewHistorial, ViewDatosUsuario {
    ...
    private void inicializarBotones() {
        ...
        mBotonEditar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PerfilUsuario.this, EditarPerfil.class));
            }
        });
    }
    ...
    private class HistorialAdapter extends AdapterRecargable<EntradaHistorial> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            RelativeLayout layout = (RelativeLayout) (convertView == null ? View.inflate(PerfilUsuario.this, R.layout.item_historial, null) : convertView);
