...
import project.catalin.mybets.controladores.iniciarSesion.fragments.ControladorIniciarSesionOpcionesLogin;
...
public class IniciarSesionFragmentOpcionesLogin extends Fragment {
    ...
    public IniciarSesionFragmentOpcionesLogin() {
        mControllerOpciones = new ControladorIniciarSesionOpcionesLogin();
    }
