package project.catalin.mybets.vistas.iniciarSesion;
...
import project.catalin.mybets.controladores.iniciarSesion.ControladorIniciarSesionPantallaPrincipal;
import project.catalin.mybets.controladores.iniciarSesion.comunicaciónVista.ViewLoginBase;
import project.catalin.mybets.vistas.iniciarSesion.comunicaciónControlador.ControllerDestructible;
import project.catalin.mybets.vistas.iniciarSesion.fragments.IniciarSesionFragmentFormularioLogin;
import project.catalin.mybets.vistas.iniciarSesion.fragments.IniciarSesionFragmentFormularioRegistrarse;
import project.catalin.mybets.vistas.iniciarSesion.fragments.IniciarSesionFragmentOpcionesLogin;
import project.catalin.mybets.vistas.pantallaPrincipal.PantallaPrincipal;
...
public class IniciarSesionPantallaPrincipal extends AppCompatActivity implements ViewLoginBase {
    ...
    public IniciarSesionPantallaPrincipal() {
        mControladorFragmentos = new ControladorIniciarSesionPantallaPrincipal(this);
    }
